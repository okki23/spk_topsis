...
if(isset($_POST['id_jabatan'])|| isset($_POST['id_pegawai']) || isset ($_POST['id_unit_kerja'])|| isset($_POST['id_bagian'])||
    ...
    if (isset($_POST['crud'])){
        if($_POST['crud']=='update'){
            ...
            $proses="UPDATE jabatan_pegawai SET id_pegawai='$id_pegawai',id_unit_kerja='$id_unit_kerja',id_bagian='$id_bagian'
        ...
        if($_POST['crud']=='tambah'){
            ...
            $sql = "INSERT INTO jabatan_pegawai (id_pegawai,id_unit_kerja,id_bagian,jabatan,Status,tgl_jabat)
                    VALUES ('".$id_pegawai."',".$id_unit_kerja.",'".$id_bagian."','".$jabatan."',".$status.",STR_TO_DATE('".$tgl_jabat."', '%d/%m/%Y')) ";
