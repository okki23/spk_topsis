<?php
    ...
    while($data_kriteria=mysqli_fetch_assoc($kriteria)){
        ...
        $sqlfornilai="SELECT C.no_pegawai,C.nama,BB.nilai,DD.akumulasi,E.nama_unit_kerja,B.jabatan,F.bagian,A.tgl_penilaian FROM penilaian A
...
$sql_rangking="SELECT no_pegawai,nama,nilai,unit_kerja,jabatan,bagian,tgl_penilaian FROM rangking ORDER BY nilai DESC limit ".$jum_terbaik." ";
