 ...
 $("#matrik").click(function () {
       ...
       if (start=='' || start==null ) {
        ...
        while (count<=penilaiancount){
            ...
            unit_kerja_kerjastring=unit_kerja_kerjastring+'&unit_kerja_kerja'+count+'='+unit_kerja_kerja[count];
            ...
            count++;
           	...
           	$.ajax({
                   ...
                   no_pegstring+nama_pegstring+unit_kerja_kerjastring+nilai_kerjastring+bagianstring+jabatan_pegstring+tgl_rangkingstring,
					success: function (respons) {
                         if (respons=='berhasil'){
